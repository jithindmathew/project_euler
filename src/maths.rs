...
#[allow(dead_code)]
/// Return the factorial of `n` as u128.
///
/// For example : `7! = 5040` .
///
/// If `n == 0` or `n == 1` , `1` is returned. (meaning `0! = 1` or `1! = 1`)
///
/// ### Panics
///
/// * When `n > 34`
...
///
/// ```
/// use project_euler::maths::factorial_as_u128 as f;
///
/// assert_eq!(f(0), 1);
/// assert_eq!(f(1), 1);
/// assert_eq!(f(2), 2);
...
/// ```
pub fn factorial_as_u128(n: u128) -> u128 {
    if n > 34 {
        panic!("{}! is larget than u128 limit : {}.", n, u128::MAX);
    }
    let ans_list: [u128; 35] = [
        1,
        1,
        2,
        6,
